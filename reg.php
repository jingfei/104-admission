...
$(document).ready( function() {
	...
	$('#applyForm').form({
		...
		plate:	{identifier: 'plate',	rules:[{type: 'empty'}] },
	});
...
<body>
	...
	<div style="width:80%;margin:70px 10%;">
		...
		<form id="applyForm" class="ui large form error secondary inverted purple piled segment" method="post" action="reg_confirm.php">
			...
			<div class="two fields">
				<div class="required six wide field">
					...
					<input type="text" placeholder="E-mail" id="email" name="email" class="required" size="35" maxlength="35" />
					<br>
				</div>
			...
			<div class="inline fields">
				<div class="ui toggle checkbox">
					<input type="checkbox" name="other3" id="other3" tabindex="0" class="hidden" />
					<label>是否自行開車前往本校</label>
				</div>
				<div class="field"></div>
				<div class="required field" style="display:none">
					<label for="plate">請填車牌號碼</label>
					<input type="text" name="plate" id="plate" placeholder="car plate number" class="required" value="X"/>
				</div>
			</div>
			<div class="field">
				<div class="ui toggle checkbox">
					<input type="checkbox" name="other1" tabindex="0" class="hidden" />
					<label>是否參加文教活動(暫訂奇美博物館)</label>
				</div>
			</div>
			<div class="field">
				<div class="ui toggle checkbox">
					<input type="checkbox" name="other2" tabindex="0" class="hidden" />
