...
while($row = mysql_fetch_array($result))
{
	...
	echo "<td><input name='school' type=text size=15 value='$row[0]'></td>";
	echo "<td><input name='office' type=text size=15 value='$row[1]'></td>";
	echo "<td><input name='title' type=text size=15 value='$row[2]'></td>";
	echo "<td><input name='name' type=text size=18 value='$row[3]'></td>";
	echo "<td><input name='id' type=text size=10 value='$row[4]'></td>";
	echo "<td><input name='birth' type=text size=10 value='$row[5]'></td>";
	echo "<td><input name='email' type=text size=28 value='$row[6]'></td>";
	echo "<td><input name='food' type=text size=3 value='$row[7]'></td>";
	echo "<td><input name='tel' type=text size=15 value='$row[8]'></td>";
	echo "<td><input name='cell' type=text size=15 value='$row[9]'></td>";
	echo "<td><input name='food1' type=text size=2 value='$row[10]'></td>";
	echo "<td><input name='food2' type=text size=2 value='$row[11]'></td>";
	echo "<td><input name='food3' type=text size=2 value='$row[12]'></td>";
	echo "<td><input name='car1' type=text size=2 value='$row[13]'></td>";
	echo "<td><input name='car2' type=text size=2 value='$row[14]'></td>";
	echo "<td><input name='car3' type=text size=2 value='$row[15]'></td>";
	echo "<td><input name='other1' type=text size=2 value='$row[16]'></td>";
	echo "<td><input name='other2' type=text size=2 value='$row[17]'></td>";
