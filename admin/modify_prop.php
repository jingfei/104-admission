...
while($row = mysql_fetch_array($result))
{
	...
	echo "<td><input name='reason' type=text size=25 value='$row[1]'></td>";
	echo "<td><input name='class1' type=text size=15 value='$row[2]'></td>";
	echo "<td><input name='class2' type=text size=6 value='$row[3]'></td>";
	echo "<td><input name='office' type=text size=15 value='$row[4]'></td>";
	echo "<td><input name='name' type=text size=18 value='$row[5]'></td>";
	echo "<td><input name='tel' type=text size=15 value='$row[6]'></td>";
	echo "<td><textarea name='text1' rows='5'>$row[7]</textarea></td>";
	echo "<td><textarea name='text2' rows='5'>$row[8]</textarea></td>";
